...
| AC-05 Saved views | **Pass** (split exception views; see README) | Live check filter results: Active Directory → 90001, 90002, 90004, 90005; Needs Verification → 90002; Missing Store Email → 90004; Missing District Manager Email → 90004; Inactive and Closed → 90003; External ID Mapping → all five |
